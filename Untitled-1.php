...
<body>  
  ...
  <h1>Evaluation Form</h1>
    ...
    <p>Name Course:
      ...
      else
      {
          ...
          {
              $errors[] = 'You forget to enter your Evaluation.';
          }
          else
          {
    ...
    $con = mysqli_connect('localhost','root','','eva') or die('Can\'t connect to mysql server');
        ...
        if(mysqli_num_rows($result)>0)
        {
            ...
            while($row = mysqli_fetch_assoc($result))
                {             
                    $name++;                 
                    echo "<tr>  <td>$row[Id_question_lecturer]</td>
                                <td>$row[text_qestion_lecturer]</td>                            
                                <td><input type='radio' id='radio1' name='$name' value='1'>
                                <input type='radio' id='radio2' name='$name' value='2'>
                                <input type='radio' id='radio3' name='$name' value='3'>
                                <input type='radio' id='radio4' name='$name' value='4'>
                                <input type='radio' id='radio5' name='$name' value='5'></th></td>";
                }
            echo '</table>';            
        }
        else
        ...
        if(mysqli_num_rows($result)>0)
        {
            ...
            {             
                $name++;                 
                echo "<tr>  <td>$row[Id_question_course]</td>
  ...
  <div class="total">
    <span>Total Evaluation:</span> <span id="total-score"></span>
  </div>
